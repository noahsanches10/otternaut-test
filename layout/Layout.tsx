...
export function Layout() {
  ...
  return (
    <div className={cn(
      "min-h-screen h-screen flex flex-col", // Added h-screen and flex flex-col
      ...
      />
      <div className="flex-1 flex relative"> {/* Added flex container */}
        <Navbar 
        ...
        />
        <main className={cn( 
          "flex-1 px-8 py-4 transition-all duration-300",
          "lg:px-8 md:px-6 sm:px-4",
          isNavCollapsed ? "lg:ml-16" : "lg:ml-40",
          "md:ml-0 sm:ml-0",
          "mt-14", // Reduced top margin for header
          "overflow-auto" // Handle scrolling at the main content level
        )}>
          <Outlet />
        </main>
      </div>
